    ...
    public static IEnumerable<ProtoBufNode> Decode(ReadOnlySpan<byte> bytes) {
        ...
        while (!reader.IsEof) {
            ...
            result.Add(type switch {
                WireType.VARINT => new UlongProtoBufNode(number, type, reader.ReadVarint()),
                WireType.I64 => new UlongProtoBufNode(number, type, reader.ReadI64()),
                WireType.LEN => new BytesProtoBufNode(number, type, reader.ReadLen()),
                WireType.I32 => new UlongProtoBufNode(number, type, reader.ReadI32()),
